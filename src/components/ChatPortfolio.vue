        ...
        <TransitionGroup name="message" tag="div" class="space-y-4">
          ...
          >
            ...
            <div
              ...
              class="max-w-[85%] px-4 py-3.5 rounded-xl bg-card border border-white/5 text-gray-200 text-sm font-mono leading-relaxed break-words"
            ...
            <div v-else-if="msg.type === 'experience'" class="w-full max-w-[90%] space-y-2.5">
              ...
              >
                <div class="flex items-start justify-between gap-4 mb-2.5">
                  <div class="min-w-0">
                    <h3 class="text-sm font-mono text-gray-100 font-medium break-words">{{ exp.role }}</h3>
                    <p class="text-xs font-mono text-gray-400 break-words">{{ exp.company }}</p>
                  </div>
            ...
            <div v-else-if="msg.type === 'skills'" class="w-full max-w-[90%]">
              ...
              <div class="px-4 py-3.5 rounded-xl bg-card border border-white/5 space-y-3">
                <div
                  ...
                  :key="group.category"
                  class="flex flex-col sm:flex-row sm:items-start sm:gap-4 gap-1.5"
                  :style="{ animation: 'card-in 0.3s ease both', animationDelay: `${gi * 80}ms` }"
                >
                  <span class="text-[11px] font-mono text-gray-600 sm:w-20 sm:shrink-0 sm:pt-0.5" :aria-label="group.category">{{ group.category }}</span>
                  <ul class="flex flex-wrap gap-1.5 list-none min-w-0" :aria-label="`${group.category} skills`">
                    <li
            ...
            <div v-else-if="msg.type === 'contact'" class="w-full max-w-[85%]">
              ...
              <div class="rounded-xl bg-card border border-white/5 overflow-hidden" style="animation: card-in 0.35s ease both">
                ...
                >
                  ...
                  <span class="flex-1 min-w-0 truncate font-mono text-sm text-gray-400 group-hover:text-gray-100 transition-colors">{{ contact.email }}</span>
                ...
                >
                  ...
                  <span class="flex-1 min-w-0 truncate font-mono text-sm text-gray-400 group-hover:text-gray-100 transition-colors">{{ contact.github.display }}</span>
                  <svg aria-hidden="true" focusable="false" class="w-3.5 h-3.5 text-gray-700 shrink-0 group-hover:text-gray-500 transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" />
                  </svg>
                </a>
                ...
                >
                  ...
                  <span class="flex-1 min-w-0 truncate font-mono text-sm text-gray-400 group-hover:text-gray-100 transition-colors">{{ contact.linkedin.display }}</span>
                  <svg aria-hidden="true" focusable="false" class="w-3.5 h-3.5 text-gray-700 shrink-0 group-hover:text-gray-500 transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" />
                  </svg>
                </a>
        ...
        >
          ...
          <div class="flex items-center group">
            <button
              ...
              class="flex-1 flex items-center gap-3 px-4 py-3.5 text-left cursor-pointer"
            >
          ...
          >
            <div v-if="isPickerOpen" id="option-picker" class="border-t border-white/5 overflow-hidden rounded-b-xl">
              ...
              <button
                ...
                class="w-full flex items-center gap-3 px-4 py-3 text-left border-b border-white/5 transition-colors group cursor-pointer"
              ...
              <button
                ...
                class="w-full flex items-center gap-3 px-4 py-3 text-left transition-colors group cursor-pointer"
