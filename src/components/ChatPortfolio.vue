            ...
            <div v-else-if="msg.type === 'contact'" class="w-full max-w-[85%]">
              ...
              <div class="rounded-xl bg-card border border-white/5 overflow-hidden" style="animation: card-in 0.35s ease both">
                ...
                >
                  ...
                  <span class="flex-1 font-mono text-sm text-gray-400 group-hover:text-gray-100 transition-colors">{{ contact.email }}</span>
                ...
                >
                  ...
                  <span class="flex-1 font-mono text-sm text-gray-400 group-hover:text-gray-100 transition-colors">{{ contact.github.display }}</span>
                  <svg aria-hidden="true" focusable="false" class="w-3.5 h-3.5 text-gray-700 shrink-0 group-hover:text-gray-500 transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" />
                  </svg>
                </a>
                ...
                >
                  ...
                  <span class="flex-1 font-mono text-sm text-gray-400 group-hover:text-gray-100 transition-colors">{{ contact.linkedin.display }}</span>
                  <svg aria-hidden="true" focusable="false" class="w-3.5 h-3.5 text-gray-700 shrink-0 group-hover:text-gray-500 transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" />
                  </svg>
                </a>
